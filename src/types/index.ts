...
export interface Survey {
  ...
  hogarId: string;
  /**
   * Método de selección muestral con el que se eligió el hogar/persona.
   * Registra el diseño para el análisis ponderado/agrupado. Vacío en históricos.
   */
