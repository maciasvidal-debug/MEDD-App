...
CREATE TABLE IF NOT EXISTS surveys (
    ...
    nv_posg        VARCHAR(40),                        -- NV_POSG: Nivel de formación posgrado (opcional)
    ...
    CONSTRAINT chk_nv_posg       CHECK (nv_posg IS NULL OR nv_posg IN
                                   ('Ninguno','Especialización','Maestría','Doctorado')),
